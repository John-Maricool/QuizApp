...
;
import static com.example.johnbatista.quizapp.ShowAnswersCatholic.TOTALQ;


public class CatholicFragment extends Fragment {

    private static final String TAG = "CatholicFragment";
     private int i = 20;
    private boolean running = true;
    private int[] rand = Catholic.getQuestionIndex();
    ...
    private onLastClick lastClick;

     interface onLastClick{
      void  doSomething(int rA, int cQ);
    }
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (clicks == 9) {
                    running = false;
                    CheckCorrectAnswers();
                    lastClick.doSomething(rightAnswers, countQuestions);
    ...
    public RadioButton[] displayQuestions(int i) {
        ...
        Catholic CATHOLIC = Catholic.catholic[i];
        String Question = CATHOLIC.getQuestions();
        questions.setText(Question);

        String[] Options = CATHOLIC.getOptions();
    ...
    private void CheckCorrectAnswers() {
        ...
        String ans = Catholic.catholic[rand[clicks]].getCorrectAnswer();
