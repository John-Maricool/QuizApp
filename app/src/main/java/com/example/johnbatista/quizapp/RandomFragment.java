...
import static com.example.johnbatista.quizapp.ShowAnswersRandom.RIGHTANSWERS;
import static com.example.johnbatista.quizapp.ShowAnswersRandom.TOTALQUESTIONS;
...
public class RandomFragment extends Fragment {
    ...
    private int[] rand = logic.getQuestionIndex();
    ...
    private onLastClickRandom lastClick;

    interface onLastClickRandom{
        void  doSomethingRandom(int rA, int cQ);
    }
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (clicks == 9) {
                    running = false;
                    CheckCorrectAnswers();
                    lastClick.doSomethingRandom(rightAnswers, countQuestions);
    ...
    public RadioButton[] displayQuestions(int i) {
        ...
        logic Logic =  logic.LOGIC[i];
        String Question = Logic.getQuestions();
    ...
    private void CheckCorrectAnswers() {
        ...
        String ans =  logic.LOGIC[rand[clicks]].getCorrectAnswer();
    ...
    public void onAttach(Context context) {
        ...
        lastClick = (onLastClickRandom) context;
    }
}